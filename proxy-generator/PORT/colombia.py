...
|_|   |_|  \___/_/\_\\__,  |      \____|\___|_| |_|\___|_|  \__,_|\__\___/|_|   
    ...
    try:
        # Using ProxyScrape API for Colombia (CO) with selected port
        url = f"https://api.proxyscrape.com/v2/?request=getproxies&protocol=http&timeout=10000&country=CO&port={port}"
